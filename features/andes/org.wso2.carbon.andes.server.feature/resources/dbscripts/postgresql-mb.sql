...
CREATE TABLE IF NOT EXISTS MB_DTX_PREPARED_XID (
    ...
    CONSTRAINT PK_MB_DTX_PREPARED_XID PRIMARY KEY (INTERNAL_XID, NODE_ID)
);
...
CREATE TABLE IF NOT EXISTS MB_DTX_PREPARED_ENQUEUE_RECORD (
    ...
    MESSAGE_METADATA BYTEA NOT NULL,
    CONSTRAINT PK_MB_DTX_PREPARED_ENQUEUE_RECORD PRIMARY KEY (MESSAGE_ID),
    CONSTRAINT FK_MB_DTX_PREPARED_ENQUEUE_RECORD FOREIGN KEY (INTERNAL_XID)
    REFERENCES MB_DTX_PREPARED_XID (INTERNAL_XID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS MB_DTX_PREPARED_DEQUEUE_RECORD (
    ...
    QUEUE_NAME VARCHAR(512) UNIQUE NOT NULL,
    MESSAGE_METADATA BYTEA NOT NULL,
    CONSTRAINT PK_MB_DTX_PREPARED_DEQUEUE_RECORD PRIMARY KEY (INTERNAL_XID, MESSAGE_ID, QUEUE_NAME),
    CONSTRAINT FK_MB_DTX_PREPARED_DEQUEUE_RECORD FOREIGN KEY (INTERNAL_XID)
    REFERENCES MB_DTX_PREPARED_XID (INTERNAL_XID) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS MB_DTX_PREPARED_ENQUEUE_CONTENT (
    MESSAGE_ID NUMERIC(19) NOT NULL,
    INTERNAL_XID NUMERIC(19) NOT NULL,
    CONTENT_OFFSET INT NOT NULL,
    MESSAGE_CONTENT BYTEA NOT NULL,
    CONSTRAINT PK_MB_DTX_PREPARED_ENQUEUE_CONTENT PRIMARY KEY (MESSAGE_ID,CONTENT_OFFSET),
    CONSTRAINT FK_MB_DTX_PREPARED_ENQUEUE_CONTENT FOREIGN KEY (MESSAGE_ID)
    REFERENCES MB_DTX_PREPARED_ENQUEUE_RECORD (MESSAGE_ID) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS MB_DTX_PREPARED_DEQUEUE_CONTENT (
    INTERNAL_XID NUMERIC(19) NOT NULL,
    MESSAGE_ID NUMERIC(19) NOT NULL,
    CONTENT_OFFSET INT NOT NULL,
    MESSAGE_CONTENT BYTEA NOT NULL,
    CONSTRAINT PK_MB_DTX_PREPARED_DEQUEUE_CONTENT PRIMARY KEY (MESSAGE_ID,CONTENT_OFFSET),
    CONSTRAINT FK_MB_DTX_PREPARED_DEQUEUE_CONTENT FOREIGN KEY (MESSAGE_ID)
    REFERENCES MB_DTX_PREPARED_DEQUEUE_RECORD (MESSAGE_ID) ON DELETE CASCADE
);
