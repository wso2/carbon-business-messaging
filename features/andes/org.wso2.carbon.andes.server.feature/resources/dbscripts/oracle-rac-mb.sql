...
CREATE TABLE MB_DTX_PREPARED_XID (
  ...
  CONSTRAINT PK_MB_DTX_PREPARED_XID PRIMARY KEY (TOPIC_ID)
)
/
CREATE TABLE MB_DTX_PREPARED_DEQUEUE_RECORD (
  ...
  CONSTRAINT PK_MB_DTX_PREPARED_DEQUEUE_RECORD PRIMARY KEY (INTERNAL_XID, MESSAGE_ID, QUEUE_ID)
  CONSTRAINT FK_MB_DTX_PREPARED_DEQUEUE_RECORD FOREIGN KEY (INTERNAL_XID) REFERENCES MB_DTX_PREPARED_XID
  ON DELETE CASCADE
)
/
CREATE TABLE MB_DTX_PREPARED_ENQUEUE_RECORD (
  INTERNAL_XID NUMBER(19) NOT NULL,
  MESSAGE_ID NUMBER(19) UNIQUE NOT NULL,
  MESSAGE_DESTINATION VARCHAR(512) NOT NULL,
  MESSAGE_METADATA RAW(2000) NOT NULL,
  CONSTRAINT PK_MB_DTX_PREPARED_ENQUEUE_RECORD PRIMARY KEY (MESSAGE_ID)
  CONSTRAINT FK_MB_DTX_PREPARED_ENQUEUE_RECORD FOREIGN KEY (INTERNAL_XID) REFERENCES MB_DTX_PREPARED_XID
  ON DELETE CASCADE
)
/
CREATE TABLE MB_DTX_PREPARED_CONTENT (
  ...
  CONSTRAINT FK_MB_DTX_PREPARED_CONTENT FOREIGN KEY (MESSAGE_ID) REFERENCES MB_DTX_PREPARED_ENQUEUE_RECORD
  ON DELETE CASCADE
)
/
