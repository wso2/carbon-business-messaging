...
CREATE TABLE MB_CLUSTER_EVENT (
    EVENT_ID NUMBER(19) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE MB_CLUSTER_COORDINATOR_HEARTBEAT (
    ...
    CONSTRAINT PK_MB_CLUSTER_COORDINATOR_HEARTBEAT PRIMARY KEY (ANCHOR)
)
/
CREATE TABLE MB_CLUSTER_NODE_HEARTBEAT (
    ...
    CONSTRAINT PK_MB_CLUSTER_NODE_HEARTBEAT PRIMARY KEY (NODE_ID)
)
/
