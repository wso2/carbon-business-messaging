...
CREATE TABLE MB_DTX_PREPARED_ENQUEUE_CONTENT (
  ...
  CONSTRAINT FK_MB_DTX_PREPARED_ENQUEUE_CONTENT FOREIGN KEY (MESSAGE_ID) REFERENCES MB_DTX_PREPARED_ENQUEUE_RECORD (MESSAGE_ID)
  ON DELETE CASCADE
)
/
CREATE TABLE MB_DTX_PREPARED_DEQUEUE_CONTENT (
  ...
  CONSTRAINT FK_MB_DTX_PREPARED_DEQUEUE_CONTENT FOREIGN KEY (MESSAGE_ID) REFERENCES MB_DTX_PREPARED_DEQUEUE_RECORD (MESSAGE_ID)
  ON DELETE CASCADE
)
