...
CREATE TABLE MB_METADATA (
    ...
    CONSTRAINT FK_MB_METADATA_QUEUE_MAPPING FOREIGN KEY (DLC_QUEUE_ID) REFERENCES MB_QUEUE_MAPPING (QUEUE_ID)
)
...
/
CREATE SEQUENCE slot_id_sequence START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER MB_SLOT_ID_TRIGGER
    ...
    FOR EACH ROW
    BEGIN
        SELECT slot_id_sequence.nextval INTO :NEW.SLOT_ID FROM dual;
    END;
/
