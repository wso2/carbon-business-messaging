...
-- WSO2 Message Broker v 3.1.0 to v 3.2.0 migration script for oracle-rac --
...
CREATE TABLE MB_DTX_PREPARED_DEQUEUE_RECORD (
  ...
  CONSTRAINT PK_MB_DTX_DEQUEUE_RECORD PRIMARY KEY (INTERNAL_XID, MESSAGE_ID, QUEUE_ID),
