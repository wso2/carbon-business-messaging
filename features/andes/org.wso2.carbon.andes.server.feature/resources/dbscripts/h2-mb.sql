...
CREATE TABLE IF NOT EXISTS MB_CONTENT (
                MESSAGE_ID BIGINT,
                CONTENT_OFFSET INT,
                MESSAGE_CONTENT BINARY(1000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS MB_RETAINED_METADATA (
                ...
                MESSAGE_ID BIGINT,
                MESSAGE_METADATA BINARY(1000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS MB_DTX_XID (
                ...
                GLOBAL_ID BINARY(1000) NOT NULL,
                BRANCH_ID BINARY(1000) NOT NULL,
