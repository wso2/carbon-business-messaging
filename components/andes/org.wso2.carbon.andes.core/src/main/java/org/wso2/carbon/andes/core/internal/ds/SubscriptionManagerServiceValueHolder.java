...
public class SubscriptionManagerServiceValueHolder {
    private RegistryService registryService;
    private RealmService realmService;
    private ConfigurationContextService configurationContextService;

    private static SubscriptionManagerServiceValueHolder instance = new SubscriptionManagerServiceValueHolder();

    public static SubscriptionManagerServiceValueHolder getInstance() {
        return instance;
    }
