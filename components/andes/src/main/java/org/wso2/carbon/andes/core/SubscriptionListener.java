...
public interface SubscriptionListener {
    ...
    /**
     * Subscription change event types
     */
     ...
     */
    void handleClusterSubscriptionsChanged(AndesSubscription subscription, SubscriptionChange changeType)
            throws AndesException;
     ...
     * @throws AndesException
     */
    void handleLocalSubscriptionsChanged(LocalSubscription subscription, SubscriptionChange changeType)
            throws AndesException;
