...
<%
    ...
    try {
        ...
        filteredNormalTopicSubscriptionList = andesAdminStub.getFilteredSubscriptions("false", "*",
            ProtocolType.AMQP.name(), DestinationType.TOPIC.name(), filteredName, identifierPattern, ownNodeId,
                                                          normalTopicPageNumber, subscriptionCountPerPage,
                                                          isFilteredNameByExactMatch, isIdentifierPatternByExactMatch);

        if (filteredNormalTopicSubscriptionList != null) {

            totalNormalTopicSubscriptionCount = andesAdminStub.getTotalSubscriptionCountForSearchResult("false", "*",
                ProtocolType.AMQP.name(), DestinationType.TOPIC.name(),filteredName,identifierPattern, ownNodeId,
                isFilteredNameByExactMatch, isIdentifierPatternByExactMatch);
        ...
        filteredActiveDurableTopicSubscriptionList = andesAdminStub.getFilteredSubscriptions("true", "true",
            ProtocolType.AMQP.name(), DestinationType.DURABLE_TOPIC.name(), filteredName, identifierPattern, ownNodeId,
                                                            activeDurableTopicPageNumber, subscriptionCountPerPage,
                                                            isFilteredNameByExactMatch, isIdentifierPatternByExactMatch);
        ...
        if (filteredActiveDurableTopicSubscriptionList != null) {
            totalActiveDurableTopicSubscriptionCount = andesAdminStub.getTotalSubscriptionCountForSearchResult("true", "true",
                ProtocolType.AMQP.name(), DestinationType.DURABLE_TOPIC.name(),filteredName,identifierPattern,
                ownNodeId, isFilteredNameByExactMatch, isIdentifierPatternByExactMatch);
        ...
        filteredInActiveDurableTopicSubscriptionList =  andesAdminStub.getFilteredSubscriptions("true", "false",
            ProtocolType.AMQP.name(), DestinationType.DURABLE_TOPIC.name(), filteredName, identifierPattern, ownNodeId,
                                                            inactiveDurableTopicPageNumber, subscriptionCountPerPage,
                                                            isFilteredNameByExactMatch, isIdentifierPatternByExactMatch);
