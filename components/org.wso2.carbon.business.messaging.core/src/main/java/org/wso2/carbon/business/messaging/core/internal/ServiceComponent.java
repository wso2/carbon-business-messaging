...
import org.wso2.carbon.business.messaging.core.GreeterImpl;
...
//    @Activate
    protected void start(BundleContext bundleContext) throws Exception {
        ...
        logger.info("Finished registering service." + DataHolder.getInstance().getCarbonRuntime()
...
//    )
    protected void setCarbonRuntime(CarbonRuntime carbonRuntime) {
        ...
        logger.info("Configuration name : " + DataHolder.getInstance().getCarbonRuntime().getConfiguration().getName());
    }
