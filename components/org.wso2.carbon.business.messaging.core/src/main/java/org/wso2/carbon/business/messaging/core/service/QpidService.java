...
public interface QpidService {
     ...
     * @return Internal AMQP connection URL
     */
     ...
     * @return External AMQP connection URL
     */
     ...
     *
     * @return Absolute path to the location where Qpid configuration files reside
     */
