...
/**
 * This is Topic Receiver Jmeter Sampler class for local transactions.
 */
public class TransactedTopicReceiver extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        result.sampleStart();
        result.setSampleLabel("Transacted Topic Receiver");
        try {
            ...
            result.setResponseMessage("Unable to consume messages from topic." + "-" + "Exception: " + ex.toString());
